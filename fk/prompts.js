window.PROMPT_CATEGORIES = [
  {
    id: 'komunikasi', icon: '📧', name: 'Komunikasi Rasmi', prompts: [
      {n:1,title:'E-mel Rasmi',text:`Bertindak sebagai pembantu pentadbiran profesional.
...
Jika sesuai, hasilkan juga versi Bahasa Inggeris.`},
      {n:2,title:'Surat Rasmi',text:`Bertindak sebagai pembantu pentadbiran profesional.

Sediakan surat rasmi mengenai [perkara] kepada [agensi/individu].

Gunakan format surat rasmi organisasi, bahasa profesional dan jelas.`},
...
Jika terdapat permintaan, nyatakan tindakan susulan yang sesuai.`}
  ...
  },
  {
    id: 'mesyuarat', icon: '📅', name: 'Pengurusan Mesyuarat', prompts: [
      {n:6,title:'Agenda Mesyuarat',text:`Bertindak sebagai setiausaha organisasi.

Sediakan agenda mesyuarat lengkap beserta objektif, agenda, pembentang dan anggaran masa.`},
      {n:7,title:'Minit Mesyuarat',text:`Berdasarkan transkrip yang diberikan, hasilkan minit mesyuarat rasmi organisasi.
...
Kekalkan istilah rasmi organisasi.`},
...
• tarikh kuat kuasa.`}
  ...
  },
  {
    id: 'program', icon: '🎓', name: 'Pengurusan Program dan Pentadbiran', prompts: [
      {n:16,title:'Kertas Kerja Program',text:`Sediakan kertas kerja lengkap bagi program berikut mengikut format organisasi.`},
...
Cadangkan anggaran masa bagi setiap tugasan.`},
      {n:25,title:'Pembantu AI Peribadi',text:`Bertindak sebagai pembantu peribadi digital untuk seorang profesional yang mengurus pelbagai tugasan.
...
Berikan jawapan yang praktikal, profesional dan sesuai dengan persekitaran kerja saya.`}
    ]
  },
  {
    id: 'poster', icon: '🎨', name: 'Reka Bentuk Poster dan Bahan Promosi', prompts: [
      {n:26,title:'Poster Program',text:`Bertindak sebagai pereka grafik profesional di sebuah organisasi.
...
• Tajuk yang menarik
• Susun atur poster
• Skema warna mengikut identiti korporat organisasi
...
Gunakan bahasa yang ringkas, profesional dan mudah difahami oleh warga organisasi.
...
Hasilkan prompt lengkap untuk Google Gemini.`},
      {n:30,title:'Kandungan Media Sosial',text:`Bertindak sebagai pegawai komunikasi korporat organisasi.
...
Gunakan bahasa yang mudah difahami, formal dan sesuai untuk warga organisasi.
