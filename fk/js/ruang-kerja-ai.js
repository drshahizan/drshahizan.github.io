document.addEventListener('DOMContentLoaded',()=>{
  ...
  const pages=[
    ...
    ['Koleksi 100 Prompt Umum','Prompt komunikasi, dokumen, perancangan, data, kreativiti dan produktiviti umum.','prompt-library.html'],
    ['Studio Prompt Builder','Bina prompt Gemini Notebook Studio mengikut tujuan, audiens, struktur, bukti dan kekangan.','studio-prompt-builder.html'],
    ['Pembina Prompt Multimedia','Bina prompt poster, infografik, banner media sosial dan muzik latar.','multimedia-builder.html'],
    ['Pembina Prompt Analisis Data','Bina prompt untuk Deep Research, Canvas, Gems dan Guided Learning.','analisis-data-builder.html'],
    ['Pusat Prompt AI','Akses perpustakaan prompt, Gemini Notebook dan Studio prompts.','prompt-ai.html'],
    ['Alat AI','Direktori alat untuk teks, dokumen, imej, video, data dan produktiviti.','ai-tools.html'],
    ...
    ['Sumber dan Templat','Lapan templat pentadbiran, komunikasi, storyboard, kuiz, glosari dan senarai semak.','sumber-ai.html'],
