document.addEventListener('DOMContentLoaded',()=>{
  ...
  document.querySelectorAll('footer').forEach(footer=>{
    ...
    const links=document.createElement('nav');links.className='footer-links';links.innerHTML='<a href="index.html">Utama</a><a href="tentatif.html">Tentatif</a><a href="nota.html">Nota Kursus</a><a href="panduan.html">Panduan</a><a href="panduan-pantas.html">Panduan Pantas</a><a href="modul.html">Modul</a><a href="latihan.html">Latihan</a><a href="latihan-lanjutan.html">Latihan Lanjutan</a><a href="cabaran-7-hari.html">Cabaran 7 Hari</a><a href="prompt-library.html">Prompt</a><a href="bantuan.html">Bantuan</a><a href="ai-tools.html">AI Tools</a>';
