document.addEventListener('DOMContentLoaded',()=>{
  ...
  document.querySelectorAll('footer').forEach(footer=>{
    ...
    const links=document.createElement('nav');links.className='footer-links';links.setAttribute('aria-label','Pautan footer');links.innerHTML='<section><b>Kursus</b><a href="index.html">Utama</a><a href="tentatif.html">Tentatif</a><a href="nota.html">Nota Kursus</a><a href="slaid.html">Slaid Pembentangan</a><a href="panduan.html">Panduan</a><a href="panduan-pantas.html">Panduan Pantas</a></section><section><b>Pembelajaran</b><a href="modul.html">Modul</a><a href="latihan.html">Latihan</a><a href="latihan-lanjutan.html">Latihan Lanjutan</a><a href="cabaran-7-hari.html">Cabaran 7 Hari</a></section><section><b>Sumber</b><a href="prompt-library.html">Perpustakaan Prompt</a><a href="ai-tools.html">AI Tools</a><a href="bantuan.html">Bantuan</a></section>';
